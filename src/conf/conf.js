const conf = {
    ...
    appwriteUserDetailCollectionId: String(import.meta.env.VITE_APPWRITE_USER_DETAIL_COLLECTION_ID),
    ...
    appwriteInterestedUsersPropertiesCollectionId: String(import.meta.env.VITE_APPWRITE_INTERESTED_USERS_PROPERTIES_COLLECTION_ID),
